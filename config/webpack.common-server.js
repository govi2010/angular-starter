  ...
  return {
    ...
    plugins: [
      ...
      new DefinePlugin({
        ...
        VERSION: '0.0',
        DEBUG_INFO_ENABLED: METADATA.ENV === 'development',
        ...
        'process.env.DEBUG_INFO_ENABLED': METADATA.ENV === 'development',
        'process.env.SERVER_API_URL': JSON.stringify(METADATA.SERVER_API_URL)
